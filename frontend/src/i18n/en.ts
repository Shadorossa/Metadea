export const en = {
  ...
  admin: {
    ...
    delete_confirm:   'Delete "{title}" from your local catalog? This cannot be undone.',
  },
  search: {
    title: 'Search',
    types: {
  ...
  settings: {
    ...
    community_catalog_sync_done: '{count} new entries added from the community.',
