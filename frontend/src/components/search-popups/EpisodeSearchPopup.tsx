...
export function EpisodeSearchPopup({
  ...
  return (
    <ModalShell
      onClose={onClose}
      label={s.placeholder_multi_source}
    ...
    >
        ...
        <div className="pr-editor-search-results pr-editor-search-results--grid">
          ...
          {!selectedShow && (
            <>
              {isSearchingShows && <div className="pr-editor-search-loading">{s.searching}</div>}
          ...
          {selectedShow && (
            <>
              {isLoadingEpisodes && <div className="pr-editor-search-loading">{s.searching}</div>}
