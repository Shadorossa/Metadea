...
import { getLegacyTmdbCharacterAppearances, remapTmdbCharacterIds } from '../../../lib/tauri/characters';
...
export function initFixCharacterIds() {
  initStatusActionButton({
    ...
    notInTauriMessage: getT().settings.tauri_only,
    labels: () => {
    ...
    errorFallback: getT().settings.unknown_error,
  });
}
