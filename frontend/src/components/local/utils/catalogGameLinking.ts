import type { LocalGame, LibraryEntry, MediaCatalogEntry, MetaEntry, DbMediaRelation } from '../../../lib/tauri';
...
import { CONTAINS_RELATION_TYPES, PART_OF_RELATION_TYPES } from '../../../lib/media/sagaTypes';
