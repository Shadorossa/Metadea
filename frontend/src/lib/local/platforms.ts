...
// Local category -> search.types key holding its translated label.
export const LOCAL_CATEGORY_TO_SEARCH_TYPE: Record<CategoryId, keyof Translations['search']['types']> = {
  'videojuegos':  'game',
  'visual-novel': 'vnovel',
  'anime':        'anime',
  'manga':        'manga',
