...
export async function getMediaSagaGroups(mediaExternalIds: string[]): Promise<Record<string, string>> {
  return tauriCmd<Record<string, string>>('get_media_saga_groups', {}, { mediaExternalIds });
}
