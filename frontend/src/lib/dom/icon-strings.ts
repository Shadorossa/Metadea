...
const INNER: Record<string, string> = {
  ...
  // Doble calificación (Settings > Preferencias) — a die-pip pair per slot,
  // since the two ratings' actual names are user-defined text (shown via
  // the button's title tooltip instead) and can't be baked into an icon.
  rating_slot_1: `<rect x="3" y="3" width="18" height="18" rx="4"/><circle cx="12" cy="12" r="1.8" fill="currentColor" stroke="none"/>`,
  rating_slot_2: `<rect x="3" y="3" width="18" height="18" rx="4"/><circle cx="8.5" cy="8.5" r="1.8" fill="currentColor" stroke="none"/><circle cx="15.5" cy="15.5" r="1.8" fill="currentColor" stroke="none"/>`,
  ...
  settings_accessibility: `<circle cx="12" cy="12" r="10"/><circle cx="12" cy="7" r="1.2"/><path d="M7.5 9.8l4.5 1.2 4.5-1.2"/><path d="M12 11v3.2l-2.2 3.8M12 14.2l2.2 3.8"/>`,
  ...
  profile_friends: `<path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/>`,
  // 4×4 grid (Yearly Bingo)
  profile_bingo: `<rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 7.5h18M3 12h18M3 16.5h18M7.5 3v18M12 3v18M16.5 3v18"/>`,
  // Chain link (lucide "link") — the profile header's "Copy web profile link"
  web_link: `<path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/>`,
};
...
export const RATING_SLOT_1_ICON = stroke(14, '2', INNER.rating_slot_1);
export const RATING_SLOT_2_ICON = stroke(14, '2', INNER.rating_slot_2);
...
export const ICON_SETTINGS_ACCESSIBILITY = stroke(14, '2', INNER.settings_accessibility);
...
export const ICON_PROFILE_FRIENDS   = stroke(20, '2', INNER.profile_friends);
export const ICON_PROFILE_BINGO     = stroke(20, '1.75', INNER.profile_bingo);
export const ICON_WEB_LINK          = stroke(16, '2', INNER.web_link);
